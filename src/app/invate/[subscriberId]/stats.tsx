...
export async function Stats({ subscriberId }: StatsProps) {
  ...
  return (
    <div className="grid gap-3 md:grid-cols-3">
      <div className="relative bg-gray-700 border border-gray-600 px-4 py-7 flex flex-col item-center justify-center gap-1 rounded-xl">
        <span className="text-center font-heading text-2xl font-semibold text-gray-200 leading-none">
          {accessCount}
        </span>
